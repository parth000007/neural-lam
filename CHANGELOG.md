...
- Remove unnecessary `wandb.init()` call from `run_simple_training()` in `tests/test_training.py` that could trigger a W&B user login prompt when running outside of pytest.
